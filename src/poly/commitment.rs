...
fn test_opening_proof() {
    ...
    use crate::transcript::{
        Blake2bRead, Blake2bWrite, ChallengeScalarEndo, ChallengeScalarType, Transcript,
    ...
    let x = transcript.squeeze_challenge_scalar(ChallengeScalarType::Default);
    ...
    assert_eq!(p, p_prime);
    let x_prime = transcript.squeeze_challenge_scalar(ChallengeScalarType::Default);
    assert_eq!(*x, *x_prime);
