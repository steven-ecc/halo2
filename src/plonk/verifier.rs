...
use crate::transcript::{
    read_n_points, read_n_scalars, ChallengeScalarType, ChallengeSpace, TranscriptRead,
};
...
pub fn verify_proof<'a, C: CurveAffine, S: ChallengeSpace<C>, T: TranscriptRead<C, S>>(
    ...
    let theta = transcript.squeeze_challenge_scalar(ChallengeScalarType::Theta);
    ...
    let beta = transcript.squeeze_challenge_scalar(ChallengeScalarType::Beta);

    // Sample gamma challenge
    let gamma = transcript.squeeze_challenge_scalar(ChallengeScalarType::Gamma);
    ...
    let y = transcript.squeeze_challenge_scalar(ChallengeScalarType::Y);

    let vanishing = vanishing::Argument::read_commitments(vk, transcript)?;

    // Sample x challenge, which is used to ensure the circuit is
    // satisfied with high probability.
    let x = transcript.squeeze_challenge_scalar(ChallengeScalarType::X);
