...
impl<F: FieldExt, L: Layouter<F>> MessageScheduleConfig<'_, F, L> {
    ...
    pub fn assign_subregion3(
        ...
        let mut new_word = |idx: usize| -> Result<(), Error> {
            ...
            let subregion3_word =
                self.decompose_subregion3_word(region_index, w[idx].value.unwrap(), idx)?;

            // sigma_1 on subregion3_word
            let (r_0_even, r_1_even) = self.lower_sigma_1(region_index, subregion3_word)?;
    ...
    fn decompose_subregion3_word(
        ...
        self.layouter().assign_existing_region(
            ...
            |mut region: Region<'_, Self>| {
                ...
                let spread_a = SpreadVar::with_lookup(
                    &mut region,
                ...
                Ok(Subregion3Word {
                    index,
                    a: spread_a.dense.into(),
                    b: CellValue32::new(b, Some(pieces[1])),
                    c: CellValue32::new(c, Some(pieces[2])),
                    d: spread_d.dense.into(),
                    spread_a: CellValue32::new(spread_a.spread.cell, spread_a.spread.value),
    ...
    fn lower_sigma_1(
        ...
        self.assign_and_constrain(region_index, || "b", a_6, row, &word.b, &configured.perm)?;
